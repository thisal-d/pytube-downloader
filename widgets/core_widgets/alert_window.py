...
class AlertWindow(ctk.CTkToplevel):
    ...
    def __init__(
        ...
        super().__init__(
            master=master, width=width, height=height, fg_color=ThemeManager.get_color_based_on_theme("background")
        )
    ...
    def set_widgets_colors(self):
        ...
        self.error_msg_label.configure(text_color=ThemeManager.get_color_based_on_theme("text_warning"))

        if self.more_details is not None:
            self.more_details_label.configure(text_color=ThemeManager.get_color_based_on_theme("text_normal"))
